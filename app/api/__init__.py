...
from app.api.transactions.create_transaction import create_transaction, CreateTransactionReponseModel
...
api_router.add_api_route(
    ...
    methods=['POST'], 
    tags=['Transaction'], 
    response_model=CreateTransactionReponseModel
)
...
api_router.add_api_route(
    '/v1/transaction-items/{transaction_id}',
